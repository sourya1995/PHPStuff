<form enctype="multipart/form-data" method="post">
    ...
    <input type="number" name="number_of_tickets_available"
        id="number_of_tickets_available" value="<?php echo isset($normalizedData['number_of_tickets_available']) ? htmlspecialchars($normalizedData['number_of_tickets_available']) : '';?>">
    <?php
    ...
    <div>
        ...
        if(isset($normalizedData['picture'])){
            ?>
            <a href="/uploads/<?php echo htmlspecialchars($normalizedData['picture'], ENT_QUOTES);?>">Current Picture</a>
            <?php
        }
        ?>
