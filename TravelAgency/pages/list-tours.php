    ...
    <tbody>
        ...
        foreach($toursData as $tourData){
            ...
            <tr>
                ...
                <td>
                    <a href="/edit-tour?id=<?php echo htmlspecialchars($tourData['id'], ENT_QUOTES);?>" class="btn btn-primary">Edit</a>
                    <form action="/delete-tour">
                        <input type="hidden" name="id" value="<?php echo htmlspecialchars($tourData['id'], ENT_QUOTES); ?>">
